import {Calendar, CalendarIcon, Clock, FileTextIcon, MapPin, Users, UsersIcon} from "lucide-react"
...
// 模拟党小组会数据
const meetings = ActivitiesAPI.data.filter((meeting) => meeting.type === '党小组会')
	...
	return (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">查看党小组会记录和安排</p>
			</div>
