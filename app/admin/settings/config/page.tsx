                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            ...
                            {foundationDate ? format(foundationDate, "yyyy-MM-dd") : <span>选择日期</span>}
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent className="w-auto p-0">
                          <Calendar mode="single" selected={foundationDate} onSelect={setFoundationDate} initialFocus />
                        </PopoverContent>
                      </Popover>
                    </div>
                    <div className="space-y-2">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4 pt-6 border-t">
                  ...
                  {committees.map((committee, index) => (
                      <div key={index} className="grid gap-4 md:grid-cols-5 items-end border p-4 rounded-md">
                        ...
                        <Button variant="ghost" size="icon" className="h-10 w-10" onClick={() => removeCommittee(index)}>
